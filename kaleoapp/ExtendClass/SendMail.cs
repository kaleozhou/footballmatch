...
namespace SendMail
{
    ...
    class SendMail
    {
        ...
        public void sendmailtest1(string m_file ,string subject,string body)
        {
            #region//设置邮件信息
            //MailMessage message = new MailMessage();//实例化邮件主体
            //message.From = new MailAddress("2992383734@qq.com", "周衍鹏");//发信人地址
            //message.To.Add(new MailAddress("616801795@qq.com", "周衍鹏"));//收信人地址
            ...
            //smtpClient.Host = "smtp.qq.com";//服务器的名称
            //smtpClient.DeliveryMethod = SmtpDeliveryMethod.Network;//指定处理邮件的方式，此处为通过网络发送到smtp服务器
            //smtpClient.Credentials = new System.Net.NetworkCredential("2992383734", "zhouyanpeng1990");//验证发件人身份，用户名kaixiyeetop，密码******
            //try
            //{
